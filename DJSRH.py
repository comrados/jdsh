...
class DJSRH:
    ...
    def eval(self):
        ...
        self.visualize_retrieval(qu_BI, qu_BT, re_BI, re_BT, qu_LI, qu_LT, re_LI, re_LT, indexes, 'DJSRH')
        ...
        build_binary_hists(qu_BI, qu_BT, re_BI, re_BT, 'DJSRH', [i[0] for i in mapshr])
